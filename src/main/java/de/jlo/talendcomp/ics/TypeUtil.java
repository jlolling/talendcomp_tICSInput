...
public final class TypeUtil {
	...
	public static Boolean convertToBoolean(Object value, String locale) throws Exception {
	 ...
	 */
	public static Date convertToDate(Object value, String pattern, Locale local) throws Exception {
		if (value instanceof String) {
			String valueStr = (String) value;
			if (valueStr.isEmpty()) {
				return null;
